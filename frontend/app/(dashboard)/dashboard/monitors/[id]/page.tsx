...
import { useGetMonitorQuery, useGetMonitorStatsQuery } from "@/store/api/monitorApi";
...
export default function MonitorDetailPage() {
    ...
    const { data: monitorData, isLoading: monitorLoading, error: monitorError } = useGetMonitorQuery(monitorId);
    const { data: statsData, isLoading: statsLoading } = useGetMonitorStatsQuery({ id: monitorId });
                                ...
                                <CardContent className="space-y-4">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600">
                                                Checked every {monitor.interval} minutes
                                            </p>
                                        </div>
                                        <div className="flex items-center gap-2">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 pt-4 border-t">
                                        <div>
                                            ...
                                            <p className="font-medium">{formatLastChecked(monitor.last_checked_at)}</p>
                                        </div>
                                        <div>
                                    ...
                                    {statsLoading ? (
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="grid grid-cols-2 gap-4 text-center">
                                                <div>
                                                    <div className="text-lg font-semibold">{stats.totalChecks}</div>
                                                    <p className="text-xs text-gray-600">Total Checks</p>
                                                </div>
                                                <div>
                                                    <div className="text-lg font-semibold">{stats.avgResponseTime}ms</div>
                                                    <p className="text-xs text-gray-600">Avg Response</p>
                                                </div>
                                            </div>
                                            <div className="text-center">
                                                <div className="text-lg font-semibold text-red-600">{stats.incidents}</div>
                        ...
                        {stats && (
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                                ...
                                <Card>
                                    ...
                                    <CardContent>
                                        <div className="text-2xl font-bold text-green-600">{stats.upChecks}</div>
                                        <p className="text-xs text-muted-foreground">
